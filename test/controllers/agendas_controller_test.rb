...
class AgendasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agenda" do
    assert_difference("Agenda.count") do
      post agendas_url, params: { agenda: { activo: @agenda.activo, citas: @agenda.citas, fecha: @agenda.fecha, hora_inicio: @agenda.hora_inicio, medico: @agenda.medico } }
    end
  ...
  test "should update agenda" do
    patch agenda_url(@agenda), params: { agenda: { activo: @agenda.activo, citas: @agenda.citas, fecha: @agenda.fecha, hora_inicio: @agenda.hora_inicio, medico: @agenda.medico } }
